...
@router.get("/download", summary="在线下载TikTok视频/图片/Online download TikTok video/image")
async def download_file_hybrid(request: Request,
                               url: str = Query(
                                   example="https://www.tiktok.com/@evil0ctal/video/7156033831819037994",
                                   description="视频或图片的URL地址，支持TikTok的分享链接，例如：https://www.tiktok.com/t/ZTR9nDNWq/"),
                               prefix: bool = True,
                               with_watermark: bool = False):
    """
    # [中文]
    ### 用途:
    - 在线下载TikTok 无水印或有水印的视频/图片
    ...
    ### 参数:
    - url: 视频或图片的URL地址，支持TikTok的分享链接，例如：https://www.tiktok.com/t/ZTR9nDNWq/
    ...
    # [English]
    ### Purpose:
    - Download TikTok video/image with or without watermark online.
    ...
    ### Parameters:
    - url: The URL address of the video or image, supports TikTok sharing links, for example: https://www.tiktok.com/t/ZTR9nDNWq/
